...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2020 pada 04.13
...
('pelanggan-', '123456', 'Pelanggan', 'Cilacap', 'T004', 'thoriq');
...
('pelanggan-', 1, 2020, 1000, 2000, 'thoriq');
...
('pelanggan-', 1, 2020, 1000, 'Belum Lunas', 'thoriq');
